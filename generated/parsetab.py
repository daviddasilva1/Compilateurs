...
_lr_productions = [
  ...
  ('programme -> statement','programme',1,'p_programme_statement','pythonParser.py',11),
  ('programme -> statement ENTER programme','programme',3,'p_programme_recursive','pythonParser.py',15),
  ('statement -> assignation','statement',1,'p_statement','pythonParser.py',19),
  ('statement -> structure','statement',1,'p_statement','pythonParser.py',20),
  ('expression -> INT','expression',1,'p_expression_num_or_var','pythonParser.py',24),
  ('expression -> FLOAT','expression',1,'p_expression_num_or_var','pythonParser.py',25),
  ('expression -> IDENTIFIER','expression',1,'p_expression_num_or_var','pythonParser.py',26),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','pythonParser.py',31),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','pythonParser.py',32),
  ('expression -> expression COMPARATOR expression','expression',3,'p_expression_op','pythonParser.py',33),
  ('assignation -> IDENTIFIER EQU expression','assignation',3,'p_assign','pythonParser.py',37),
  ('statement -> PRINT expression','statement',2,'p_statement_print','pythonParser.py',42),
  ('structure -> IF expression POINTS ENTER TAB programme #','structure',7,'p_structure_if','pythonParser.py',47),
  ('structure -> DEF expression ( ) POINTS ENTER TAB programme #','structure',9,'p_structure_function','pythonParser.py',51),
  ('structure -> WHILE expression POINTS ENTER TAB programme #','structure',7,'p_structure_while','pythonParser.py',55),
  ('expression -> ( expression )','expression',3,'p_expression_paren','pythonParser.py',59),
]
